  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
        ...
        {!hadAdjust && (
          <p className="text-xs text-muted-foreground mt-2">
            <span className="inline-flex items-center gap-1">
              <span className="w-4 h-4 rounded-full bg-gray-200 text-gray-400 inline-flex items-center justify-center text-[10px] font-bold">—</span>
      ...
      <Card className="border border-[#E8E8E8] rounded-2xl shadow-sm overflow-hidden">
        <CardHeader className="px-6 py-4 bg-[#27265C]">
          <CardTitle className="text-sm font-semibold text-white flex items-center gap-2">
            ...
            {ORDER_ID} — подтверждённый состав
          </CardTitle>
        </CardHeader>
        <CardContent className="px-6 py-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="bg-emerald-50 rounded-xl p-3">
              <p className="text-xs text-muted-foreground mb-0.5">Плановая дата отгрузки</p>
            ...
            <div className="bg-[#F7F8FA] rounded-xl p-3">
              ...
              <p className="font-semibold text-[#27265C]">Козлов А.П.</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200 text-xs">
                {CONFIRMED_ITEMS.length} позиций
              </Badge>
            </div>
            <div className="border border-[#E8E8E8] rounded-xl overflow-hidden">
              ...
              <div className="px-4 py-3 bg-emerald-50 border-t border-[#E8E8E8] flex justify-between items-center">
      ...
      <div className="flex gap-3 pb-6">
        <Link to={`/order/${ORDER_ID}/adjust-new`}>
        ...
        <Button
          disabled={!confirmed}
          className={`h-12 px-6 font-bold shadow-sm transition-all ${confirmed ? "bg-[#FCC71E] hover:bg-[#e6b41a] text-[#27265C]" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}
