  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card className="border border-[#E8E8E8] rounded-2xl shadow-sm overflow-hidden">
        <CardContent className="px-8 py-10 text-center space-y-5">
          {/* Success icon */}
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#27265C]">Заказ подтверждён</h1>
          ...
          <div className="grid grid-cols-3 gap-3 text-sm mt-2">
            <div className="bg-[#F7F8FA] rounded-xl p-3">
              ...
              <p className="font-bold text-[#27265C]">{ORDER_ID}</p>
            </div>
            <div className="bg-emerald-50 rounded-xl p-3">
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1">Плановая дата отгрузки</p>
          ...
          {/* Backorder block */}
          {HAS_BACKORDER && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 text-left space-y-3">
          ...
          <div className="flex gap-3 pt-2">
            <Link to="/orders" className="flex-1">
              <Button
                variant="outline"
                className="w-full h-11 border-[#27265C]/20 text-[#27265C] hover:bg-[#27265C]/5"
              >
                Все заказы
              </Button>
            </Link>
