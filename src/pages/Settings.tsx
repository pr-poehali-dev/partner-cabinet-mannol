...
const Settings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-[#27265C]">Настройки</h1>
        <p className="text-gray-600 mt-1 text-sm md:text-base">Персонализация портала и управление уведомлениями</p>
      </div>
